...
const WeProvideMenu = ({
  ...
  return (
    <>
      ...
      >
        <div className='menu-0 h-full md:p-5 w-[90vw] md:w-[75vw] flex flex-col md:flex-row justify-between space-y-5 md:space-x-5'>
        ...
        <div className='menu-1 h-full md:p-5  w-[90vw] md:w-[75vw]'>
        ...
        <div className='menu-2 h-full md:p-5  w-[90vw] md:w-[75vw]'>
